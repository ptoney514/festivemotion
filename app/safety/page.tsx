...
const sections: GuidelineSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Avoid placing on wet, soft, or unstable surfaces.",
      "Keep away from radiators, heating vents, and direct sunlight.",
  ...
  },
  {
    ...
    items: [
      ...
      "Store in a cool, dry location away from UV light.",
  ...
  },
  {
    ...
    items: [
      ...
      "Allow paint to cure fully (24–48 hrs) before powering on.",
    ],
  },
  {
    id: "warranty",
